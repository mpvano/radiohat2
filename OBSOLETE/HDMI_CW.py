...
# Title: Hdmi Cw
# Generated: Wed Oct 13 11:09:32 2021
##################################################
...
class HDMI_CW(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Hdmi Cw")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Hdmi Cw")
        ...
        self.settings = Qt.QSettings("GNU Radio", "HDMI_CW")
        ...
        self.audio_sink_1 = audio.sink(samp_rate, 'hw:b1,0', False)
...
def main(top_block_cls=HDMI_CW, options=None):
