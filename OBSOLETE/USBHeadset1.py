...
# Title: Usbheadset1
# Generated: Wed Oct 13 10:59:48 2021
##################################################
...
class USBHeadset1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Usbheadset1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Usbheadset1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "USBHeadset1")
        ...
        self._LPF_range = Range(50, 600, 10, 50, 200)
        ...
        for c in range(0, 1):
            self.RXTXTabs_grid_layout_0.setColumnStretch(c, 1)
        self._HPF_range = Range(700, 3000, 50, 2750, 200)
        ...
        self.audio_sink_1 = audio.sink(samp_rate, 'hw:Audio,0', False)
...
def main(top_block_cls=USBHeadset1, options=None):
