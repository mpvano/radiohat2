...
class FMTest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.blocks_multiply_const_xx_0 = blocks.multiply_const_ff(0.1, 1)
        ...
        self.KQ2H_squelch29_620m = analog.ctcss_squelch_ff(samp_rate, 146.2, 0.01, 0, 0, False)
        ...
        # Connections
        ##################################################
        self.connect((self.KQ2H_squelch29_620m, 0), (self.blocks_multiply_const_xx_0, 0))
        self.connect((self.analog_nbfm_rx_0, 0), (self.KQ2H_squelch29_620m, 0))
