...
class headset(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Headset")
        ...
        self.settings = Qt.QSettings("GNU Radio", "headset")
        ...
        self.band_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.band_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.audio_source_0 = audio.source(samp_rate, 'hw:RadioHatCodec,1', True)
        ...
        self.MuteIfNotTX = MuteIfNotTX.blk(example_param=22)
        self.MuteIfNotRX = MuteIfNotRX.blk(example_param=23)
        ...
        # Connections
        ##################################################
        self.connect((self.MuteIfNotRX, 0), (self.blocks_add_xx_1_0, 0))
        self.connect((self.MuteIfNotRX, 0), (self.blocks_add_xx_1_1, 0))
        self.connect((self.MuteIfNotTX, 0), (self.analog_agc2_xx_1, 0))
        ...
        self.connect((self.audio_source_0, 0), (self.MuteIfNotTX, 0))
        ...
        self.connect((self.blocks_add_xx_1_0, 0), (self.audio_sink_0, 0))
        self.connect((self.blocks_add_xx_1_1, 0), (self.audio_sink_0, 1))
        ...
        self.connect((self.blocks_throttle_0, 0), (self.MuteIfNotRX, 0))
        self.connect((self.blocks_throttle_0_0, 0), (self.blocks_complex_to_imag_1, 0))
        self.connect((self.blocks_throttle_0_0, 0), (self.blocks_complex_to_real_1, 0))
        ...
        self.connect((self.hilbert_fc_1_0, 0), (self.blocks_throttle_0_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.blocks_add_xx_1_0, 1))
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_add_xx_1_1, 1))
...
def main(top_block_cls=headset, options=None):
